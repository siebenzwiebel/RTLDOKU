...
- einer Methode zum Starten des Threads, in Abhängigkeit ob der alte Thread noch am Leben ist
- einer Methode in der entschieden wird, ob eine Lightsho generiert, oder regeneriert werden soll
